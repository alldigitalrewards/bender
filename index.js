...
app.get('/person/:programId/:personId', (req, res) => {
    const person = {
        ...
        firstname: req.query.firstname ?? "Bender Sam",
        lastname: req.query.lastname ?? "Arthur Rodriguez",
        phone: '4074583861',
...
app.all('/transaction_authorization', (req, res) => {
    // if the query variable "lang" is es_US, return a 401
    if (req.query.lang === 'es_US') {
